...
export const properties: Property[] = [
  ...
  },
  {
    ...
    description: 'Seguridad y patrimonio familiar en su estado más sólido. Ubicado en un sector con vecindario ya establecido, este lote ofrece la tranquilidad de un entorno consolidado y la certeza de una inversión que protege tus ahorros contra la inflación. Es el espacio ideal para quienes buscan edificar un legado familiar en una ubicación donde la demanda habitacional es constante y la oferta de tierra es cada vez más limitada.',
    image: '/properties/costa-salinas-drone-2.jpg',
    features: ['Vecindario Consolidado', 'Servicios Listos', 'Alta Demanda', 'Documentación Premium'],
    type: 'terreno',
