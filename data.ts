...
export const properties: Property[] = [
  // COSTA SALINAS - Lotes
  {
    ...
    title: 'Costa Salinas: Etapa Avenida',
    location: 'Costa Salinas - Zona Comercial',
    price: 85000000,
    size: 360,
    dimensions: '12x30',
    monthlyPayment: 950000,
    description: 'Ubicación estratégica sobre avenida principal. El potencial comercial es inmediato. Ideal para quienes buscan que su terreno trabaje para ellos: construí locales abajo y departamentos arriba. Una inversión que se paga sola.',
    image: '/properties/costa-salinas-drone-1.jpg',
    features: ['Sobre Avenida', 'Potencial Comercial', 'Alta Visibilidad', 'Escritura Inmediata'],
    type: 'terreno',
  ...
  },
  {
    ...
    location: 'Costa Salinas - Zona Tranquila',
    price: 78000000,
    size: 360,
    dimensions: '12x30',
    monthlyPayment: 890000,
    description: 'La paz que buscás, a metros del desarrollo. Este sector está diseñado para la vida familiar, rodeado de naturaleza pero conectado a todo. El lugar donde tus hijos van a jugar seguros. Un refugio de valor.',
    image: '/properties/costa-salinas-drone-2.jpg',
    features: ['Zona Residencial', 'Entorno Verde', 'Barrio Consolidado', 'Financiación Flexible'],
    type: 'terreno',
  ...
  },
  {
    id: 'cs-003',
    zoneId: 'costa-salinas',
    title: 'Costa Salinas: Lote Esquina Premium',
    location: 'Costa Salinas - Sector Alto',
    price: 135000000,
    size: 450,
    dimensions: '15x30',
    monthlyPayment: 1500000,
    description: 'La joya del loteamiento. Lote esquina con doble fachada y topografía elevada. La vista desde aquí domina el entorno. Para el inversor exigente que sabe que las esquinas siempre valen más.',
    image: '/properties/costa-salinas-drone-1.jpg', // Reusing drone 1 as generic nice view
    features: ['Lote Esquina', 'Doble Frente', 'Topografía Elevada', 'Ubicación Premium'],
    type: 'terreno',
