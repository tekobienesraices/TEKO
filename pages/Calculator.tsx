...
export const Calculator: React.FC = () => {
  ...
  const initialPrice = Number(searchParams.get('price')) || 50000;
            ...
            <div className="p-8 md:p-10 space-y-8">
              <div>
                <label className="flex justify-between text-sm font-medium text-slate-700 mb-2">
                  ...
                  <span className="font-bold text-teko-navy">${price.toLocaleString()}</span>
                </label>
                <input 
                  type="range" 
                  min="30000" 
              ...
              <div>
                <label className="flex justify-between text-sm font-medium text-slate-700 mb-2">
                  ...
                  <span className="font-bold text-teko-navy">${downPaymentAmount.toLocaleString()}</span>
                </label>
                <input 
                  type="range" 
                  min="10" 
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mb-8 border-t border-white/10 pt-6 text-sm text-slate-300">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium">${financedAmount.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Total Financiado (aprox)</span>
                    <span className="text-white font-medium">${Math.round(totalFinanced).toLocaleString()}</span>
                  </div>
                </div>
