...
import { Calculator as CalcIcon, Send, ChevronDown, ChevronUp, Sparkles, AlertCircle, Check, Info, TrendingDown, ThumbsUp } from 'lucide-react';
    ...
    <div className="pt-24 min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mt-12">
          <Link to="/terrenos" className="text-teko-navy font-medium hover:underline inline-flex items-center gap-2">
